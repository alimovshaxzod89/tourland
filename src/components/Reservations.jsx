      ...
      <div className="-mt-20" id="info">
        <div className="max-w-[1380px] mb-10 px-5 flex flex-col gap-4 md:flex-row items-center justify-between  mx-auto">
          <div className="md:w-[32%] px-4 w-full bg-white rounded-2xl flex flex-col items-center justify-center gap-5 h-[290px] shadow-xl">
            ...
            <h2 class="font-bold text-center text-[16px] sm:text-[20px] text-[#2a2a2a]">
              Make a Phone Call
            </h2>
            <a class="text-main text-center" href="tel:+998771113777">
              <p style={{color: "rgb(168, 202, 61)"}}>+998 77 111 37 77</p>
            </a>
          </div>
          <div class="md:w-[32%] px-4 w-full bg-white rounded-2xl flex flex-col items-center justify-center gap-5 h-[290px] shadow-xl">
            <div class="bg-[#f0f0f0] rounded-full w-[60px] h-[60px] grid place-items-center text-main text-2xl">
              <svg
                stroke="currentColor"
                fill="currentColor"
                stroke-width="0"
            ...
            <a class="text-main text-center" href="">
